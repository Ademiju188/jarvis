  ...
  <div class="max-w-7xl mx-auto p-6">
    ...
    <div v-else-if="visit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <div class="mt-1">
            <RichTextEditor
              ...
              :key="'context-' + visit.id + '-' + isEditing"
        ...
        <div>
          ...
          <div class="mt-1">
            <RichTextEditor
              ...
              :key="'progress-' + visit.id + '-' + isEditing"
      ...
      <div v-else class="space-y-6">
        ...
        <!-- Headmaster Feedback -->
        <div v-if="visit.headteacher_feedback" class="bg-blue-50 p-4 rounded-lg">
          <h3 class="text-sm font-medium text-blue-800 mb-2">Headmaster Feedback</h3>
          <p class="text-blue-900">{{ visit.headteacher_feedback }}</p>
        </div>
      </div>
      </div>
