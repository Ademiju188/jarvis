      ...
      <div class="bg-white py-8 px-6 shadow-lg rounded-lg">
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            ...
            <router-link to="/headteacher/register" class="font-medium text-blue-600 hover:text-blue-500">
...
export default {
  ...
  methods: {
    async login() {
      ...
      try {
        const response = await fetch('/headteacher/login', {
          method: 'POST',
          headers: {
        ...
        if (response.ok) {
          // Redirect to headteacher dashboard on successful login
          window.location.href = '/headteacher/dashboard'
        } else {
